...
<body>
    <div id="app">
        <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="{{route('admin.products.index')}}">My Products</a>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ url('admin/products') }}">{{__('Dashboard')}}</a>
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() === 'admin.products.index' ? 'active' : ''}}" href="{{route('admin.products.index')}}">
                                    ...
                                    <i class="fas fa-pencil fa-sm fa-fw"></i> Products
                                </a>
                            </li>
                        </ul>
                </nav>
